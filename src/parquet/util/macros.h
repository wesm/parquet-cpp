...
#define PARQUET_EXPORT ARROW_EXPORT
#define PARQUET_NO_EXPORT ARROW_NO_EXPORT
#define PARQUET_DEPRECATED ARROW_DEPRECATED
#define PARQUET_TEMPLATE_EXPORT ARROW_TEMPLATE_EXPORT
#define PARQUET_EXTERN_TEMPLATE ARROW_EXTERN_TEMPLATE
